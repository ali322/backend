<div class="form" id='goods_form_wrap'>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'brand_id'); ?>
                <?php
                    $this->widget('ext.easyui.EasyuiCombobox',array(
                     'url'=>Yii::app()->createUrl('brand/remoteData'),
                     'model'=>$model,
                     'attribute'=>'brand_id'
                ));
                ?>
		...
		<?php echo $form->labelEx($model,'cat_id'); ?>
                <?php
                    $this->widget('ext.easyui.EasyuiCombotree',array(
                     'url'=>$this->createUrl('goodsCate/remoteData'),
                     'model'=>$model,
                     'attribute'=>'cat_id',
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'good_number',array('size'=>20,'maxlength'=>255)); ?>
	...
	<div class="row">
		...
		<?php $this->widget("ext.dxheditor.DxhEditor",array(
			'model'=>$model_,
			'attribute'=>'good_desc',
			'options'=>array(
			'height'=>'350',
	...
	<div class="row buttons">
		...
		<?php echo CHtml::ajaxSubmitButton($model->isNewRecord ? Yii::t('project','Create') : Yii::t('project','Save'),
                        '',
                        array('success'=>'js:function(data){
                            $("#goods_form_wrap").parent().html(data);
                        }')
                       // array('update'=>$model->isNewRecord?'#add_window':'#edit_window')
                        ); ?>
	</div>
