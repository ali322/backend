...
//	public $layout='//layouts/column2';
        ...
        public function actions(){
           return array(
               'loadData'=>array(
                   ...
                   'selects'=>array('cat_id','cat_name','cat_alia','sort_order'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['NewsCate']))
		{
			$model->attributes=$_POST['NewsCate'];
			if($model->save())
	...
	//	$dataProvider=new CActiveDataProvider('NewsCate');
	...
	{
		$model=new NewsCate('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NewsCate']))
			$model->attributes=$_GET['NewsCate'];
	...
	{
		$model=NewsCate::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='news-cate-form')
		{
