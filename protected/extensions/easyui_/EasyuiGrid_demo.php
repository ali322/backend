	...
	public function initToolbar(){
		...
		if(isset($this->toolbar_show['add'])){
			...
			$this->cs->registerScript('addRow',"
				function addRow(){
                                                $('#btnadd').attr({'href':'".$this->toolbar_show['add']['href']."'})
				}
		...
		if(isset($this->toolbar_show['multiple'])){
			...
			",CClientScript::POS_END);
                ...
                /*导出excel*/
                /*
                $toolbars[]=array('id'=>'btnexport','text'=>Yii::t('easyui', 'Export Excel'),'iconCls'=>'icon-export','handler'=>'function(){exportRow()}');
	...
	public function initOperations(){
		...
		$this->cs->registerScript('editRow',"
			function editRow(row_id){
                               window.location.href='{$this->toolbar_show['edit']['href']}/id/'+row_id;
			}
			function viewRow(row_id){
                               window.location.href='{$this->toolbar_show['view']['href']}/id/'+row_id;
			}
		",CClientScript::POS_END);
	}
